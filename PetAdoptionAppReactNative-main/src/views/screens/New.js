...
import pets from '../../const/favouritepets';
import pets1 from'../../../src1/const/favouritepets';
import AsyncStorage from '@react-native-async-storage/async-storage';

const {height} = Dimensions.get('window');
const petCategories = [
  {name: 'PETS', icon: 'paw'},
  {name: 'ACCESSORIES', icon: 'shopping-outline'},
    ...
    <TouchableOpacity
      ...
      <View style={style.cardContainer}>
        ...
        <View style={style.cardDetailsContainer}>
          ...
          <Text style={{fontSize: 16, marginTop: 5, color: COLORS.primary}}>
            {pet?.price}
          </Text>

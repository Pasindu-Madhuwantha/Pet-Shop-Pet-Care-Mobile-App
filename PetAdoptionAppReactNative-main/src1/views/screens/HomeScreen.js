...
const petCategories = [
  {name: 'ITEMS', icon: 'shopping-outline'},
  {name: 'FOODS', icon: 'carrot'},
  {name: 'TOYS', icon: 'google-circles-communities'},
  {name: 'MEDS', icon: 'bottle-tonic-plus'},
    ...
    <TouchableOpacity
      ...
      <View style={style.cardContainer}>
        ...
        <View style={style.cardDetailsContainer}>
          ...
          <Text style={{fontSize: 18, marginTop: 5, color: COLORS.red}}>
            {pet?.type}
          </Text>
